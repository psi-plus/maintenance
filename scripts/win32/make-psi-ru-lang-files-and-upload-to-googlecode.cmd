...
call 7z a -mx9 "%PSIPLUSDIR%\psi-ru-lang-2011-12-25.7z" "%PSIPLUSDIR%\psi_ru.qm" "%PSIPLUSDIR%\qt_ru.qm"
@echo Completed
@echo Uploading archived Psi+ Russian localization binaries to Google Code
call googlecode_upload.py -p "psi-dev" -s "Psi+ Russian Localization || Qt 4.7.4" -l "Russian,Localization,Archive" "%PSIPLUSDIR%\psi-ru-lang-2011-12-25.7z"
@echo Completed
pause & pause
