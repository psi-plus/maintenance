...
; Psi+ installation script, v1.0.1
...
!define PRODUCT_VERSION "0.16.361"
...
OutFile "setup\psi-plus-0.16.361-win32-setup.exe"

; Use compression
SetCompressor /SOLID lzma

BrandingText "Copyright © 2008-2014 ${COMPANY_NAME}"

; -----------------------------------------------------------------------------
; Version Information
VIAddVersionKey  "CompanyName"     "${COMPANY_NAME}"
VIAddVersionKey  "LegalCopyright"  "© 2008-2014 ${COMPANY_NAME}"
VIAddVersionKey  "ProductName"     "${PRODUCT_NAME}"
VIAddVersionKey  "ProductVersion"  "${PRODUCT_VERSION}"
VIAddVersionKey  "FileDescription" "${PRODUCT_NAME} ${PRODUCT_VERSION}"
VIAddVersionKey  "FileVersion"     "${PRODUCT_VERSION}"
VIProductVersion "0.16.361.0"
...
Section "!Psi+ Core Components" SectionPsiPlusCoreComponents
  ...
  RMDir "$INSTDIR\aspell\dict\"
	...
	File "setup\aspell\en_US.multi"
	File "setup\aspell\koi8-r.cmap"
	File "setup\aspell\koi8-r.cset"
	File "setup\aspell\ru.dat"
	File "setup\aspell\ru.multi"
	File "setup\aspell\ru_affix.dat"
	File "setup\aspell\ru_RU.multi"
	File "setup\aspell\ruen.rws"
	File "setup\aspell\split.kbd"
	File "setup\aspell\standard.kbd"
...
Section "Psi+ Translations" SectionPsiPlusTranslations
	...
	File "setup\translations\psi_fa.qm"
...
Section Uninstall
  ...
  ;Cleanup Psi+ Core Components
	...
	Delete "$INSTDIR\aspell\dvorak.kbd"
	Delete "$INSTDIR\aspell\en.dat"
	Delete "$INSTDIR\aspell\en.multi"
	Delete "$INSTDIR\aspell\en_US.multi"
	Delete "$INSTDIR\aspell\koi8-r.cmap"
	Delete "$INSTDIR\aspell\koi8-r.cset"
	Delete "$INSTDIR\aspell\ru.dat"
	Delete "$INSTDIR\aspell\ru.multi"
	Delete "$INSTDIR\aspell\ru_affix.dat"
	Delete "$INSTDIR\aspell\ru_RU.multi"
	Delete "$INSTDIR\aspell\ruen.rws"
	Delete "$INSTDIR\aspell\split.kbd"
	Delete "$INSTDIR\aspell\standard.kbd"
  ...
  Delete "$INSTDIR\gstprovider.dll"
	...
	Delete "$INSTDIR\translations\psi_fa.qm"
