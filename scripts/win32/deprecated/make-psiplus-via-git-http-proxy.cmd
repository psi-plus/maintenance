...
"%GITDIR%\bin\git" clone https://github.com/psi-im/psi.git
@echo Completed
@echo Cloning submodules from official repository
cd psi
"%GITDIR%\bin\git" clone https://github.com/psi-im/iris.git
cd src
"%GITDIR%\bin\git" clone https://github.com/psi-im/libpsi.git
cd ..\..
@echo Completed
rem pause
...
cd psi
qconf
configure  --enable-whiteboarding --with-openssl-inc=%OPENSSLDIR%\include --with-openssl-lib=%OPENSSLDIR%\lib\MinGW --disable-xss --disable-qdbus --with-aspell-inc=%MINGWDIR%\include --with-aspell-lib=%MINGWDIR%\lib
@echo ================================
