...
"%GITDIR%\bin\sed" "s/\(xxx\)/%revision%/-debug" "patches\9999-psiplus-application-info.diff.backup">patches\9999-psiplus-application-info.diff
cd psi
...
move /Y src\debug\psi-plus.exe ..\psi-plus.exe
@goto exit
