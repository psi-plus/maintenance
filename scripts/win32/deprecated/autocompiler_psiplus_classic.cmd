...
configure  --with-openssl-inc=%OPENSSLDir%\outinc --with-openssl-lib=%OPENSSLDir%\lib\MinGW --disable-xss --disable-qdbus --with-aspell-inc=%QTDIR%\..\mingw\include --with-aspell-lib=%QTDIR%\..\mingw\lib
IF ERRORLEVEL 1 ECHO Unable to configure & GOTO :reversing_to_psi
CD ..
GOTO :compiling
