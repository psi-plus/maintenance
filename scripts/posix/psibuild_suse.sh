...
sudo zypper in libqt5-qtbase-common-devel libidn-devel libqca-qt5 zlib-devel libqt5-qdbus xscreensaver aspell-devel libqt5-qtx11extras-devel libqt5-qtmultimedia-devel qconf
